      ...
      if (!isDeployed) {
        ...
        try {
          ...
          if (USE_PAYMASTER_FOR_DEPLOY) {
            ...
            const { createPaymasterClient } = await import(
          ...
          try {
            ...
            if (receipt.success) {
              setMsg(
                `Smart account deployed! TX: ${receipt.receipt.transactionHash}\nCreating delegation...`
              );
            } else {
            ...
            if (deployCode && deployCode !== "0x") {
              setMsg(
                `Smart account deployed (receipt timeout but bytecode exists)\nCreating delegation...`
              );
            } else {
              throw waitError;
            }
